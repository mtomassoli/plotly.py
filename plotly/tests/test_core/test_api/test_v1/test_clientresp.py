...
class ClientrespTest(PlotlyApiTestCase):
    ...
    def setUp(self):
        ...
        self.request_mock.return_value = self.get_response('{}', 200)
    ...
    def test_data_only(self):
        ...
        expected_data = (
            '{{"args": "[{{\\"name\\": \\"what else floats?\\", \\"y\\": '
            '[3, 5]}}]", "key": "bar", "kwargs": "{{}}", "origin": "plot", '
            '"platform": "python", "un": "foo", "version": "{}"}}'
    ...
    def test_data_and_kwargs(self):
        ...
        expected_data = (
            '{{"args": "[{{\\"name\\": \\"what else floats?\\", \\"y\\": '
            '[3, 5]}}]", "key": "bar", "kwargs": "{{\\"filename\\": \\"ok\\", '
            '\\"layout\\": {{\\"title\\": \\"mah plot\\"}}}}", "origin": '
            '"plot", "platform": "python", "un": "foo", "version": "{}"}}'
            .format(version.__version__)
        )
        self.assertEqual(kwargs['data'], expected_data)
        self.assertTrue(kwargs['verify'])
